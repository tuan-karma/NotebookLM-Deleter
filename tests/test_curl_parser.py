...
class TestCurlParser(unittest.TestCase):
    ...
    def test_successful_parsing(self):
        ...
        self.assertIsNotNone(
            parsed_data, "Hàm parse không nên trả về None với file hợp lệ."
        )
        self.assertIsInstance(
            parsed_data, dict, "Kết quả trả về phải là một dictionary."
        )
        ...
        self.assertEqual(
            query_params["rpcids"][0],
            "wXbhsf",
            "rpcids phải là 'wXbhsf' cho lệnh lấy danh sách.",
        )
